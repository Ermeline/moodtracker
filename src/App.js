        ...
        render(){
            return(
                <React.Fragment>
                    ...
                    <label>Datum: <input value={this.state.date} onChange={this.updateDate.bind(this)} type="number"/></label>
                    <label>Emotion: <input value={this.state.emotions} onChange={this.updateEmotions.bind(this)} type="img"/></label>
                    <label>Situation: <input value={this.state.situation} onChange={this.updateSituation.bind(this)} type="text"/></label>
                    <label>Was brauchst du?: <input value={this.state.need} onChange={this.updateNeed.bind(this)} type="text"/> </label>
                    <label>Verhalten: <input value={this.state.behavior} onChange={this.updateBehavior.bind(this)} type="text"/></label>
